...
<head>
    ...
    <link rel="stylesheet" href="listeMannequin.css">
...
<body>
    ...
    <form class="form" method="POST" action="">
        ...
        <!--<div class="navPic">
            ...
            echo '<a href="modif.php?id='. $mannequin['id'] .'">Modifier</a>';
               echo'</div>';
            }
            ?>
        </div>-->
        <div class="line"></div>
        <h2>Tous les mannequins</h2>
        <div class="navPicAll">
            <?php
            if (empty($keywords) or $result == []){
                foreach($tab as $mannequin){
                    echo '<div>';
                affichage($mannequin['id']);
                echo '<a href="modif.php?id='. $mannequin['id'] .'">Modifier</a>'."<br>" ;
                echo '<a id="del" href="delete.php?id='. $mannequin['id'] .'">Supprimer</a>';
                echo '</div>';
                }
            }
            else {
                ...
                affichage($mannequin['id']);
                echo '<a href="modif.php?id='. $mannequin['id'] .'">Modifier</a>';
                echo '<a id="del" ?id='. $mannequin['id'] .'">Supprimer</a>';
                echo '</div>';
                }
            }
            ?>
