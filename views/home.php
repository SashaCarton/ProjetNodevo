...
<body>
    ...
    <script>
        ...
        document.querySelector('.arrowRight').addEventListener('click', function () {
            ...
            document.querySelector('.navPic').style.transform = 'translateX(' + (-page * 33) + 'vw)';
        });
        ...
        document.querySelector('.arrowLeft').addEventListener('click', function () {
            ...
            document.querySelector('.navPic').style.transition = 'transform 0.5s ease-in-out';
            document.querySelector('.navPic').style.transform = 'translateX(' + (-page * 30) + 'vw)';
            window.location.href = '/home#women';
        });
        ...
        document.querySelectorAll('.navPic div').forEach(div => {
            div.addEventListener('mouseover', function () {
                ...
                temp = 10000;
                document.querySelector('#' + id).style.transform = 'scale(1.25)';
                ...
                document.querySelectorAll('.navPic div').forEach(element => {
                    if (element.id !== id) {
                        ...
                        element.style.transition = 'filter 0.5s ease-in-out';
                    }// ici le hover info pitetre bisous
                    arreterSlideshow();
                });
            });
        });
